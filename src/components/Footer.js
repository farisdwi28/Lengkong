...
const Footer = () => {
  return (
    <section>
      <footer class="w-full bg-[#515D6A] dark:bg-gray-900">
          ...
          <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
              ...
              <p className="text-white mt-2">
                <bold>Phone</bold> : (022) 87523248
              </p>
            </div>
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white text-white">
                  Links
                </h2>
